...
\`\`\`bash
shasum -a 256 -c CrossTerm_1.5.1_aarch64.dmg.sha256
\`\`\`
...
**Silent install:**
\`\`\`powershell
msiexec /i CrossTerm_1.5.1_x64_en-US.msi /quiet /norestart
\`\`\`

**Silent uninstall:**
\`\`\`powershell
msiexec /x CrossTerm_1.5.1_x64_en-US.msi /quiet /norestart
\`\`\`

### Verify checksum (optional)

\`\`\`powershell
Get-FileHash CrossTerm_1.5.1_x64-setup.exe -Algorithm SHA256
# Compare output to CrossTerm_1.5.1_x64-setup.exe.sha256
\`\`\`
...
\`\`\`bash
# Download
wget https://github.com/alal76/CrossTerm/releases/latest/download/CrossTerm_1.5.1_amd64.deb

# Install
sudo dpkg -i CrossTerm_1.5.1_amd64.deb
...
\`\`\`bash
# Fedora / RHEL
sudo dnf install CrossTerm-1.5.1-1.x86_64.rpm
\`\`\`
...
wget https://github.com/alal76/CrossTerm/releases/latest/download/CrossTerm_1.5.1_amd64.AppImage
chmod +x CrossTerm_1.5.1_amd64.AppImage

# Run directly
./CrossTerm_1.5.1_amd64.AppImage
\`\`\`
