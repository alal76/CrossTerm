...
function renderArticleContent(article: HelpArticle | undefined, t: (key: string) => string) {
  if (article?.slug === "plugin-cookbook") return <PluginCookbook />;
  if (article) return <MarkdownRenderer content={article.body} />;
  return <p className="text-sm text-text-disabled">{t("help.noResults")}</p>;
}
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-w-0">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            {renderArticleContent(activeArticle, t)}
          </div>
        </div>
      </div>
    </div>
