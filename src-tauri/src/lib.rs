...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            vault::biometric::vault_biometric_available,
            vault::biometric::vault_unlock_biometric,
            vault::biometric::vault_biometric_enroll,
            // Vault: OS Credential Store (BE-VAULT-08)
            vault::os_store::vault_os_store_available,
            vault::os_store::vault_os_store_save,
            vault::os_store::vault_os_store_retrieve,
            vault::os_store::vault_os_store_delete,
            // Vault: FIDO2/WebAuthn (BE-VAULT-09)
            vault::fido2::vault_fido2_available,
            vault::fido2::vault_fido2_register_begin,
            vault::fido2::vault_fido2_register_complete,
            vault::fido2::vault_fido2_auth_begin,
            vault::fido2::vault_fido2_auth_complete,
            // Vault: TOTP second factor (BE-VAULT-10)
            vault::totp::vault_has_totp,
            vault::totp::vault_verify_totp,
            ...
            cloud::aws::cloud_aws_start_instance,
            cloud::aws::cloud_aws_stop_instance,
            ...
            cloud::azure::cloud_azure_start_vm,
            cloud::azure::cloud_azure_stop_vm,
            ...
            cloud::gcp::cloud_gcp_auth_login,
            cloud::gcp::cloud_gcp_list_instances,
            cloud::gcp::cloud_gcp_start_instance,
            cloud::gcp::cloud_gcp_stop_instance,
            ...
            cloud::kubectl_get_namespaces,
            cloud::kubectl_list_pods,
            // Mosh
            mosh::mosh_connect,
            mosh::mosh_write,
            mosh::mosh_resize,
