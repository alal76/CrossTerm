cask "crossterm" do
  ...
  url "https://github.com/AAlmonstorth/CrossTerm/releases/download/v#{version}/CrossTerm_#{version}_aarch64.dmg"
  name "CrossTerm"
  desc "Cross-platform terminal emulator and remote access suite"
  homepage "https://github.com/AAlmonstorth/CrossTerm"
